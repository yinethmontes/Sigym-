...
<h3 class="ui-widget-header ui-corner-all"><span class="footrow Estilo11">Inicio de Sesión  </span><span class="Estilo11">SIGYM</span></h3>
  ...
  <form action="" method="post" id="form1">
    <table border="0" width="71%">
      ...
      <tr>
        <td height="21" colspan="3" align="right" valign="top"><span class="Estilo5"><span class="Estilo4">Para efectuar el registro <a href="registro.php">Diligencie el Formulario</a> <br>
  Acercarse al Gimnasi</span>o para confirmar el registro</span></td>
      </tr>
    </table>
  </form>
</div>
