...
$nom_pag = "cambiar_clave_admin.php";
...
if(@$_POST['edit']){
	$usu = $_SESSION["ide"]; 
	$cla = md5($_POST['cla']); //encriptar clave con md5
	$c_1 = md5($_POST['c_1']); //encriptar clave con md5
	...
	if(mysql_num_rows($query) > 0){
		...
		header("Location: index_admin.php?logout=1&men=5");    
		exit(); 	
	}else{
...
<link href="css/estilo_menu.css" rel="stylesheet" type="text/css" />
	<ul class="list">
		<li><a href="index_deportista.php">Inicio</a></li>
		<li><a href="actualizar_dep.php">Actualizar Datos</a></li>
		<li><a href="cambiar_clave_depo.php">Cambiar Contraseña</a></li>
		<li><a href="http://cibersoft07.galeon.com/" >Ayuda</a></li>
	</ul>
	<div class="clear"></div>
</div>

<p class="slide"><a href="#" class="btn-slide">Menú</a>
<!-- INICIO CONTENIDO -->
<script type="text/javascript">
$().ready(function() {	
	$("#form1").validate({
  ...
  <tr>
    <td colspan="3" align="center"><input type="submit" name="edit" id="edit" value=" Actualizar" <?php echo $ti3; ?> " /> <input type="button" name="cancelar2" id="cancelar2" value="   Cancelar   " onclick="location='index_admin.php'" /></td>
    </tr>
</table>
</form>
  </div>
