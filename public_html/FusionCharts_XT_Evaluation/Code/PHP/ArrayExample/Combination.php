    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="header">
               ...
               <div class="logo"><a class="imagelink"  href="../../../../index_admin.php"><img src="../../../../images/logo.jpg" width="150" height="53" alt="FusionCharts XT logo" /></a></div>&nbsp;&nbsp;
                <!--
            ...
            <div class="content-area">
                <div id="content-area-inner-main">
                    ...
                    <div class="gen-chart-render">
                        ...
                        $sql="SELECT COUNT(*) AS NUM FROM deportista WHERE DEP_SEX='F'";
                        $result = mysql_query($sql);
                        $rows=mysql_fetch_array($result);
                        $ingreso_femenino=$rows['NUM'];
                        
                        $sql="SELECT COUNT(*) AS NUM FROM deportista WHERE DEP_SEX='M'";
                        $result = mysql_query($sql);
                        $rows=mysql_fetch_array($result);
                        ...
                        $strXML = "<chart palette='4' caption='Registro de Usuarios por Genero' PYAxisName='' SYAxisName='' numberPrefix='' formatNumberScale='0' showValues='0' decimals='0' >";
